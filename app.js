    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p style=\"font-size:11px\"><b>الوزن: </b>" + itemData.weight + " | <b>العدد: </b> " + itemData.amount + " | <b>الجودة:: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>"
        ...
        // };
            ...
            $(".item-info-stats").html('<p>الوزن: '+((itemData.weight * itemData.amount) / 1000).toFixed(1) +' | العدد: '+itemData.amount+ ' | الجودة:: '+itemData.info.quality.toFixed(0)+'%</p>') 
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html(
                    ":التعريف<p><strong></strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>الذخيرة:</strong><span>" +
                    itemData.info.ammo +
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html(
                    ...
                    "</span></p><p><strong>التعريف: </strong><span>" +
                    itemData.info.serie +
                ...
                $(".item-info-description").html(
                    ...
                    "</span></p><br /><p>" +
                    itemData.description +
                    "</p><p style=\"font-size:11px\"><b>الوزن: </b>" + itemData.weight + " | <b>العدد: </b> " + itemData.amount + " | <b>الجودة:: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>"
                );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.info.costs + "</p><p style=\"font-size:11px\"><b>الوزن: </b>" + itemData.weight + " | <b>العدد: </b> " + itemData.amount + " | <b>الجودة:: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "stickynote") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.info.label + "</p><p style=\"font-size:11px\"><b>الوزن: </b>" + itemData.weight + " | <b>العدد: </b> " + itemData.amount + " | <b>الجودة:: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
            ...
            var cardNumber = "************" + res;
            $(".item-info-description").html('<p><strong>Card Holder: </strong><span>' + itemData.info.name + '</span></p><p><strong>Citizen ID: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Card Number: </strong><span>' + cardNumber + '</span></p><p style=\"font-size:11px\"><b>الوزن: </b>' + itemData.weight + " | <b>العدد: </b> " + itemData.amount + " | <b>الجودة:: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "labkey") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Lab: " + itemData.info.lab + "</p><p style=\"font-size:11px\"><b>الوزن: </b>" + itemData.weight + " | <b>العدد: </b> " + itemData.amount + " | <b>الجودة:: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        } else {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:11px\"><b>الوزن: </b>" + itemData.weight + " | <b>العدد: </b> " + itemData.amount + " | <b>الجودة:: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        }
    } else {
        $(".item-info-title").html("<p>" + itemData.label + "</p>");
        $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:11px\"><b>الوزن: </b>" + itemData.weight + " | <b>العدد: </b> " + itemData.amount + " | <b>الجودة:: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
...
(() => {
    ...
    Inventory.QualityCheck = function(item, IsHotbar, IsOtherInventory) {
        ...
        Inventory.Open = function(data) {
            ...
            $(".ply-iteminfo-container").css("opacity", "0.0");
             $('.cashinv').html('<i class="fas fa-money-bill-wave"></i>'+' $الكاش:'+v.money)
             $('.bankinv').html('<i class="fas fa-wallet"></i>'+'  $البنك:'+v.bank)
            // $('.cashinv').html('<i class="fas fa-money-bill-wave"></i>'+' $ '+v.money+' | '+'<i class="fas fa-wallet"></i>'+' $ '+v.bank) 
            $('.nameinv').html(''+v.pname+'')
            $('.idinv').html(''+v.pid+'')
            $('.health').html('<i class="fas fa-heartbeat"></i>'+'الصحة:'+data.charhealth+'%')
            $('.shield').html('<i class="fas fa-shield-alt"></i>'+' الدرع:'+data.chararmor+'%')
